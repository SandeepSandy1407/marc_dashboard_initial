  ...
  return(props.trigger)? (
    <div className = "tools-container">
            ...
            <nav className='nav-container-menu'>
                <button onClick={()=>(props.setQueue(false), props.setMenu(true))} className='back-buttton' >
          ...
          <ul className='queue-list-container'>
            ...
            <img src = "https://res.cloudinary.com/dg9wsic7j/image/upload/v1705568718/rbt1_qkpxhi.png" className='menu-create-img'/>
          </button>
          </div>
